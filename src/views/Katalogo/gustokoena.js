...
$(document).ready(function () {
    ...
    const updateFavoriteMenu = () => {
        ...
        favorites.forEach(fav => {
            const favoriteCard = $('<div>').addClass('card-favorite');
            $('<p>').addClass('title').text(fav.title).appendTo(favoriteCard);
            $('<p>').text(fav.model).appendTo(favoriteCard);
            $('<p>').text(fav.name).appendTo(favoriteCard);
            $('<p>').text(fav.price).appendTo(favoriteCard);
