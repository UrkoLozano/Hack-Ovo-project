    ...
    <div class="filter-section">
        <form method="GET">
            ...
            <select name="seleccion1" id="seleccion1">
                ...
                <option value="<?= itzuli("aurr")?>" <?php if (isset($_GET['seleccion1']) && $_GET['seleccion1'] === 'aurreragokoak') echo 'selected="selected"'; ?>><?= itzuli("aurr")?></option>
                <option value="<?= itzuli("lehen")?>" <?php if (isset($_GET['seleccion1']) && $_GET['seleccion1'] === 'lehenagokoak') echo 'selected="selected"'; ?>><?= itzuli("lehen")?></option>
            </select>
            <button aria-label="Filtratu" type="submit" class="filter-button" id="filter-button"><?= itzuli("filterButt")?></button>
        </form>
    </div>
