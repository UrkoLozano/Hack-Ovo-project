...
<html lang="eus">
    ...
    <main>
        <section class="hero">
            <a href="../Katalogo/katalogoa.php" class="btn"><?= itzuli("kataButt"); ?></a>
        </section>
        <section class="featured-offers">
            <div class="offer">
                <h2 style=color:red;><?= itzuli("eskaintzak"); ?></h2>
                <img src="../../../public/portatil4.png" alt="Laptop en oferta">
                <h3>HP ProBook</h3>
                <p><?= itzuli("oferta1desk"); ?></p>
                <p class="price">800€</p>
            </div>
            <div class="offer">
                <img src="../../../public/software.jpg" alt="Software en oferta">
                <h3>Microsoft Office 365</h3>
                <p><?= itzuli("oferta2desk"); ?></p>
                <p class="price">35€</p>
            </div>
        </section>
    </main>
