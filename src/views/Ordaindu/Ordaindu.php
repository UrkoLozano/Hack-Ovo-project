...
define('HREF_SRC', $KARPETA_DIR . "/src");
?>
<html>
<header>
    <?php session_start(); ?>
...
<body>
    <script src="<?= HREF_SRC ?>/views/Katalogo/app.js" async></script>
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['nan'])) {
        ...
        if ($stmt) {
            ...
            json_encode(["code" => "500", "message" => "Error: No se pudo preparar la consulta."]);
            die;
        }
    ...
    <div class="container">
        ...
        <div id="ordaindu2" style="display:none">
            Oso ondo burutu da erosketa hau da zuen kodea #<span id="codCompra"></span>
        </div>
        <div id="ordaindu3" style="display:none">
            <div>Arazo bat gertatu da saiatu berriz</div>
            <div><a href="Ordaindu.php">Joan ordainketa orrira</a></div>
        </div>
    </div>
</body>
